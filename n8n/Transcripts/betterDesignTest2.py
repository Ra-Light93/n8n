...
def get_cyberpunk_style() -> dict:
    ...
    """
    return {
        "font_name": "Impact",           # Bold, techy font but cleaner
        "font_size": "17",               # Smaller as requested
        "primary_color": "FF3366",       # Pinkish-red neon
        "secondary_color": "33CCFF",     # Cyan neon
        "outline_color": "9933FF",       # Purple outline
        "back_color": "000000",          # Pure black background
        
        "bold": "1",
        "italic": "0",
        "spacing": "-1.5",              # Subtle overlap
        "scale_x": "98",                # Slightly narrower
        "scale_y": "95",                # Slightly shorter
        
        # REFINED GLOW - smaller but still visible
        "outline": "4",                 # Moderate outline
        "shadow": "5",                  # Medium shadow
        ...
        "margin_l": "15",
        "margin_r": "15",
        "margin_v": "80",              # Lower margin for bottom placement
    }
...
def build_force_style(font_style: dict) -> str:
    ...
    return (
        ...
        f"BackColour=&H{shadow_color},"  # This becomes the shadow color
        f"BorderStyle=1,"
        f"Outline={outline},"
        f"Shadow={shadow},"
...
if __name__ == "__main__":
    ...
    output_file = "n8n/Results/test2.mp4"
